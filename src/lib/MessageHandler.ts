...
export class MessageHandler {
  ...
  private readonly handlers: Map<string, MessageHandlerType[]>;
   ...
   */
  public on(type: string, handler: MessageHandlerType): void {
   ...
   */
  public off(type: string, handler: MessageHandlerType): void {
    const handlers = this.handlers.get(type);
